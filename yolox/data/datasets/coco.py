...
class COCODataset(Dataset):
    ...
    def pull_item(self, index):
        ...
        return img, therm, bbox_, img_info, index
    ...
    def __getitem__(self, index):
        ...
        """
        img, therm, res, img_info, img_id = self.pull_item(index)
        #print(img_id) 
        if self.preproc is not None:
            img, therm, target = self.preproc(img, therm, res, self.input_dim)
        return img, therm, target, img_info, img_id
